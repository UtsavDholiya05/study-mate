        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          >
            ...
            <View style={{
              ...
              <TextInput value={formData.username} onChangeText={validateName} placeholder="Enter your username" style={inputStyle} />
              {errors.username ? <Text style={errorStyle}>{errors.username}</Text> : null}

              {/* Email */}
              <Text style={{ marginLeft: 15, marginTop: 10 }}>Email</Text>
              <TextInput value={formData.email} onChangeText={validateEmail} placeholder="Enter your email" keyboardType="email-address" style={inputStyle} />
              ...
              <View style={{ flexDirection: "row", alignItems: "center", width: "100%", position: "relative" }}>
                ...
                />
                <TouchableOpacity onPress={() => setIsPasswordVisible((prev) => !prev)} style={{ position: "absolute", right: 15, padding: 10 }}>
                  <Icon name={isPasswordVisible ? "eye-off" : "eye"} size={20} color="#000" />
                </TouchableOpacity>
              </View>
              {errors.password ? <Text style={{ color: "red", marginLeft: 15, marginTop: 5 }}>{errors.password}</Text> : null}
              ...
              <TextInput
                ...
                style={inputStyle}
              />
              {errors.contact ? <Text style={errorStyle}>{errors.contact}</Text> : null}

              {/* Sign Up Button */}
              <TouchableOpacity onPress={handleSignup} style={{ backgroundColor: "#000", padding: 15, borderRadius: 40, alignItems: "center", marginTop: 20 }}>
              ...
              <View style={{ flexDirection: "row", justifyContent: "center", marginTop: 15 }}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("login")}>
                  <Text style={{ color: "#566D67", fontWeight: "bold", textDecorationLine: "underline" }}>Login</Text>
                </TouchableOpacity>
              </View>
            </View>
          </ScrollView>
